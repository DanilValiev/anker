...
use App\EasyAdmin\Fields\Bank131MoneyField;
use App\Enum\AlternativeCurrencies;
 ...
 */
final class Bank131MoneyConfigurator implements FieldConfiguratorInterface
{
    ...
    {
        return Bank131MoneyField::class === $field->getFieldFqcn();
    }

    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        $currencyCode = $this->getCurrency($field, $entityDto);
        if (null !== $currencyCode && !Currencies::exists($currencyCode) && !in_array($currencyCode, AlternativeCurrencies::$all) && $currencyCode != '') {
