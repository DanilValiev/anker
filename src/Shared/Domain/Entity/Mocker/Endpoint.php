...
class Endpoint
{
    ...
    #[ORM\OneToMany(mappedBy: 'endpoint', targetEntity: Proxy::class, cascade: ['persist'])]
    #[ORM\JoinColumn(nullable: true)]
    private Collection $proxy;

    #[ORM\OneToMany(mappedBy: 'endpoint', targetEntity: ProxyLog::class)]
    #[ORM\JoinColumn(nullable: true)]
    ...
    {
        if ($this->parameters->removeElement($param)) {
